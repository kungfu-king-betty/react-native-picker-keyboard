...
import { PickerKeyboardIOS } from '../../src';
...
function PickerKeyboardExample() {
...
function PickerKeyboardStyleExample() {
  const [carMake, setCarMake] = React.useState<string>('cadillac');
...
export const title = '<PickerKeyboardIOS>';
export const description =
  'Render lists of selectable options with UIPickerView.';
export const examples = [
  {
    title: '<PickerKeyboardIOS>',
    render: PickerKeyboardExample,
  },
  {
    title: '<PickerKeyboardIOS> with custom styling',
    render: PickerKeyboardStyleExample,
  },
];
